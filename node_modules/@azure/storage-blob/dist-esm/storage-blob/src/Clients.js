...
import { DEFAULT_MAX_DOWNLOAD_RETRY_REQUESTS, URLConstants, DEFAULT_BLOB_DOWNLOAD_BLOCK_BYTES, DEFAULT_BLOCK_BUFFER_SIZE_BYTES, BLOCK_BLOB_MAX_STAGE_BLOCK_BYTES, BLOCK_BLOB_MAX_UPLOAD_BLOB_BYTES, BLOCK_BLOB_MAX_BLOCKS, ETagAny, ETagNone } from "./utils/constants";
import { setURLParameter, extractConnectionStringParts, appendToURLPath, generateBlockID, toBlobTagsString, toQuerySerialization, truncatedISO8061Date, toBlobTags, toTags } from "./utils/utils.common";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        response = _b.sent();
                        wrappedResponse = __assign(__assign({}, response), { tags: toTags({ blobTagSet: response.blobTagSet }) || {} });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.upload(blobFactory(0, size), size, __assign(__assign({}, options), { tracingOptions: __assign(__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(size <= options.maxSingleShotSize)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.upload(function () { return streamFactory(0); }, size, __assign(__assign({}, options), { tracingOptions: __assign(__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                    ...
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.commitBlockList(blockList_3, __assign(__assign({}, options), { tracingOptions: __assign(__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (((_a = e_34.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "BlobAlreadyExists") {
                            ...
                            return [2 /*return*/, __assign(__assign({ succeeded: false }, (_b = e_34.response) === null || _b === void 0 ? void 0 : _b.parsedHeaders), { _response: e_34.response })];
                        }
                        span.setStatus({
                            code: CanonicalCode.UNKNOWN,
                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (((_a = e_50.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "ContainerAlreadyExists") {
                            ...
                            return [2 /*return*/, __assign(__assign({ succeeded: false }, (_b = e_50.response) === null || _b === void 0 ? void 0 : _b.parsedHeaders), { _response: e_50.response })];
                        }
                        span.setStatus({
                            code: CanonicalCode.UNKNOWN,
                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (((_a = e_54.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "ContainerNotFound") {
                            ...
                            return [2 /*return*/, __assign(__assign({ succeeded: false }, (_b = e_54.response) === null || _b === void 0 ? void 0 : _b.parsedHeaders), { _response: e_54.response })];
                        }
                        span.setStatus({
                            code: CanonicalCode.UNKNOWN,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        resposne = _b.sent();
                        wrappedResponse = __assign(__assign({}, resposne), { segment: __assign(__assign({}, resposne.segment), { blobItems: resposne.segment.blobItems.map(function (blobItemInteral) {
                                    var blobItem = __assign(__assign({}, blobItemInteral), { tags: toTags(blobItemInteral.blobTags) });
                                    return blobItem;
                                }) }) });
                        return [2 /*return*/, wrappedResponse];
                    case 3:
