 ...
 */
export declare interface BlobQueryCsvTextConfiguration extends BlobQueryTextConfiguration {
    /**
 ...
 */
export declare interface BlobQueryJsonTextConfiguration extends BlobQueryTextConfiguration {
    /**
 ...
 */
export declare interface BlobQueryTextConfiguration {
    /**
     * Record separator.
     *
     * @type {string}
 ...
 * @enum {string}
 */
export declare type ListBlobsIncludeItem = 'copy' | 'deleted' | 'metadata' | 'snapshots' | 'uncommittedblobs' | 'versions' | 'tags';
/**
